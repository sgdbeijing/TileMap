var mapconfig = [
    {x:0, y:0, walkable:true, image:"road_jpg"},
        ...
        {x:1, y:5, walkable:false, image:"noRoad_png"},
        {x:1, y:6, walkable:true, image:"road_jpg"},
        {x:1, y:7, walkable:true, image:"road_jpg"},
        {x:1, y:8, walkable:false, image:"noRoad_png"},
        {x:1, y:9, walkable:true, image:"road_jpg"},
        {x:2, y:0, walkable:false, image:"noRoad_png"},
        {x:2, y:1, walkable:false, image:"noRoad_png"},
        {x:2, y:2, walkable:false, image:"noRoad_png"},
        {x:2, y:3, walkable:false, image:"noRoad_png"},
        {x:2, y:4, walkable:true, image:"road_jpg"},
        {x:2, y:5, walkable:false, image:"noRoad_png"},
        {x:2, y:6, walkable:true, image:"road_jpg"},
        {x:2, y:7, walkable:true, image:"road_jpg"},
        {x:2, y:8, walkable:false, image:"noRoad_png"},
        ...
        {x:3, y:3, walkable:false, image:"noRoad_png"},
        {x:3, y:4, walkable:false, image:"noRoad_png"},
        {x:3, y:5, walkable:false, image:"noRoad_png"},
        {x:3, y:6, walkable:true, image:"road_jpg"},
        {x:3, y:7, walkable:true, image:"road_jpg"},
        {x:3, y:8, walkable:false, image:"noRoad_png"},
        ...
        {x:4, y:8, walkable:false, image:"noRoad_png"},
        ...
        {x:5, y:3, walkable:false, image:"noRoad_png"},
        ...
        {x:5, y:6, walkable:true, image:"road_jpg"},
        {x:5, y:7, walkable:true, image:"road_jpg"}, 
        {x:5, y:8, walkable:false, image:"noRoad_png"},
        ...
        {x:6, y:3, walkable:false, image:"noRoad_png"},
        {x:6, y:4, walkable:false, image:"noRoad_png"},
        {x:6, y:5, walkable:true, image:"road_jpg"},
        {x:6, y:6, walkable:true, image:"road_jpg"},
        {x:6, y:7, walkable:true, image:"road_jpg"},  
        {x:6, y:6, walkable:true, image:"road_jpg"},
        {x:6, y:7, walkable:true, image:"road_jpg"}, 
        {x:6, y:8, walkable:false, image:"noRoad_png"},
        ...
        {x:7, y:6, walkable:true, image:"road_jpg"},
        {x:7, y:7, walkable:true, image:"road_jpg"}, 
        {x:7, y:8, walkable:false, image:"noRoad_png"},
        ...
        {x:8, y:7, walkable:false, image:"noRoad_png"},  
        ...
        {x:9, y:7, walkable:false, image:"noRoad_png"},  
